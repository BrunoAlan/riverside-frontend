...
// Pinned chrome at the top of the checkout modal: title, centered logo, and
// close control. Rendered inside DialogPrimitive.Content so DialogPrimitive.Close
// resolves to the dialog root.
export function BookingFormTopBar() {
  return (
    <div className="relative z-10 flex shrink-0 items-center justify-between gap-3 rounded-t-3xl bg-neutral-50/95 px-4 py-3 backdrop-blur sm:px-6">
