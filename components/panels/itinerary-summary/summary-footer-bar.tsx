...
export function SummaryFooterBar({ total }: { total: string }) {
  return (
    <div className="border-beige-300 flex shrink-0 flex-wrap items-center justify-between gap-3 rounded-b-3xl border-t bg-neutral-50/95 px-4 py-4 backdrop-blur sm:px-6">
